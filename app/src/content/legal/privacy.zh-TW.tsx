export default function PrivacyZhTW() {
  return (
    <>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">一、蒐集的資料項目</h2>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">二、蒐集目的</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">三、第三方資料處理者</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">四、資料留存期限</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        資料於帳號存續期間留存。當你刪除帳號後，我們將於 30 天內清除所有可辨識個人的資料，但法令要求保留者（如訂閱計費紀錄）除外。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">五、你的權利</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">六、Cookie 與追蹤技術</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        本服務僅使用必要 session cookie（SameSite=Lax）維持登入狀態，不使用第三方追蹤或行為分析 cookie。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">七、資料安全</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
        <li>全站 HTTPS 加密傳輸</li>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">八、未成年使用者</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        未滿 18 歲之使用者應於法定代理人同意下使用本服務。若你為法定代理人並發現子女未經同意註冊，請來信通知我們移除。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">九、政策變更</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        本政策若有重大變更，我們將透過服務介面或電子郵件通知，並於本頁更新「最後更新日期」。繼續使用即視為同意變更後的條款。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">十、聯絡方式</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
