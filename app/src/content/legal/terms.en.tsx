export default function TermsEn() {
  return (
    <>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">1. Service Description</h2>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">2. Account</h2>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">3. Fees and Subscriptions</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">4. Acceptable Use</h2>
      <p className="mt-3 text-base leading-7 text-text-light">You agree not to:</p>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">5. Intellectual Property</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">6. AI Output Disclaimer</h2>
      <p className="mt-3 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">7. Availability and Limitation of Liability</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">8. Changes to Terms</h2>
      <p className="mt-3 text-base leading-7 text-text-light">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-text">9. Governing Law and Jurisdiction</h2>
      <p className="mt-3 text-base leading-7 text-text-light">
