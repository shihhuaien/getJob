export default function TermsZhTW() {
  return (
    <>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">一、服務說明</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        本服務為 AI 驅動的求職管理平台，提供職缺追蹤、履歷管理、求職信生成、AI 履歷優化、面試模擬、成效分析等功能。服務內容與功能可能不定期調整。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">二、帳戶</h2>
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">三、費用與訂閱</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">四、可接受使用</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        使用本服務時，你同意不從事下列行為：
      </p>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">五、智慧財產權</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">六、AI 產出之免責</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        本服務運用大型語言模型（Google Gemini）提供 AI 輔助功能，包含履歷優化、求職信生成、面試評分與回饋。AI 產出內容僅供參考，不保證正確性或適用性；使用者應於送出前自行確認並承擔最終使用責任。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">七、服務中斷與責任限制</h2>
      <ul className="mt-2 list-disc space-y-1 pl-6 text-base leading-7 text-gray-600">
      ...
      <h2 className="mt-10 text-2xl font-semibold text-gray-900">八、條款修改</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
        本服務得不時修改本條款。重大變更將透過服務介面或電子郵件通知，並於本頁更新「最後更新日期」。繼續使用本服務即視為同意變更後條款。
      </p>

      <h2 className="mt-10 text-2xl font-semibold text-gray-900">九、準據法與管轄</h2>
      <p className="mt-3 text-base leading-7 text-gray-600">
